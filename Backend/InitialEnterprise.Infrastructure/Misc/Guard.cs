...
namespace InitialEnterprise.Infrastructure.Utils
{
    public static class Guard
    {
        ...
        {
            if (assertion) throw (TException) Activator.CreateInstance(typeof(TException), message);
        }
        ...
        {
            if (candidate == null) throw (TException) Activator.CreateInstance(typeof(TException), message);
        }

        public static void AgainstNotNull<TException>(object candidate, string message = "")
