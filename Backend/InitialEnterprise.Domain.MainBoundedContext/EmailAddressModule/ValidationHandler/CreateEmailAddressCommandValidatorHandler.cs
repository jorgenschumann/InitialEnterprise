...
{
    public class CreateEmailAddressCommandValidatorHandler : CommandValidator<EmailAddressCreateCommand>
    {
        public override ValidationResult Validate(ValidationContext<EmailAddressCreateCommand> context)
        {
