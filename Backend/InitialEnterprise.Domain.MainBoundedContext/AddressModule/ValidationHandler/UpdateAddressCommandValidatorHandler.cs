...
{
    public class UpdateAddressCommandValidatorHandler : CommandValidator<AddressUpdateCommand>
    {
        public override ValidationResult Validate(ValidationContext<AddressUpdateCommand> context)
        {
