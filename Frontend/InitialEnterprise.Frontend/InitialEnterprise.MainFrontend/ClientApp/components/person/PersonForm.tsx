...
import { ControlLabel, Modal, AlertComponent, HelpBlock, FormGroup } from 'react-bootstrap';
import { Person as PersonEntity, MailAdresses, PersonFormButtonType, Person, ValidationResult, Model, PersonFormState, ValidationFailure } from './types';
...
export class PersonForm extends React.Component<PersonFormProps, Partial<PersonFormState>> {
    constructor(props: PersonFormProps & ValidationResult) {
        super(props);
        this.state = { person: props.person ? { ...props.person } : { Id: '', FirstName: '', LastName: '' }, validationResult: props.validationResult };
